...
foreach p("debug" "release" "__tmp" "lib" "_a-docs" "iphoneos" "iphonesimulator" "Debug" "Release-iphoneos" "Release-iphonesimulator" "Ardi.xcodeproj" "project.xcworkspace" "xcshareddata")
    set ftemp=$p
...
foreach p("Makefile" "core" "a-docs.tar.gz" "._" "._*cpp")
    set ftemp=$p"*"
    echo $p `find . -type f -name "$ftemp" | wc -l`
    find . -type f -name "$ftemp" -exec rm {} \;
end
